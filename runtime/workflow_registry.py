...
DISCOVERY_EVIDENCE_TO_GROWTH_SPRINT_PROPOSAL = _workflow(
    ...
    _step(
        ...
        outputs=(
            "discovery_synthesis",
            "growth_problem_or_opportunity",
            "why_further_strategic_work_is_justified",
            "proposed_scope",
            "workstreams_and_questions",
            "expected_growth_blueprint_outputs",
...
GROWTH_SPRINT_TO_RESEARCH_ENGINE = _workflow(
    ...
    _step(
        ...
        inputs=("approved_growth_sprint_scope", "research_requirements", "research_sources", "client_context"),
        outputs=(
            "research_tasks",
            "evidence_pack",
            "source_provenance",
