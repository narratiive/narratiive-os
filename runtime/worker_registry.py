...
def build_tony_worker_registry(
    ...
    if campaign_world_triage_adapter is not None:
        registrations.append(
            WorkerRegistration(
                WorkerMetadata(
                    worker_id="tony-campaign-world-triage",
                    provider="narratiive-os",
                ...
                campaign_world_triage_adapter,
            )
        )

    if creative_bible_triage_adapter is not None:
        registrations.append(
            WorkerRegistration(
                WorkerMetadata(
                    worker_id="tony-creative-bible-triage",
                    provider="narratiive-os",
    ...
    if campaign_world_triage_adapter is None:
